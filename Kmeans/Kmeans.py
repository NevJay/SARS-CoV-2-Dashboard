...
df = pd.read_csv("D:/Data Science group project/final1.csv")
print(df.DNAENC)
scaler = MinMaxScaler()
...
df['Gene name'] = scaler.fit_transform(df[['Gene name']])
...
df['cluster'].to_csv("D:/Data Science group project/final2.csv",index=False, sep=',')